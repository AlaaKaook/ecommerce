  ...
  <div class="body-wrapper">
    ...
    <aside class="mdc-drawer mdc-drawer--dismissible mdc-drawer--open">
      ...
      <div class="mdc-drawer__content">
        <div class="user-info">
          <p class="name">Alaa Kaook</p>
          <p class="email">Alaa@gmail.com</p>
        </div>
        ...
        <div class="mdc-card premium-card">
          <div class="d-flex align-items-center">
            ...
            <div>
              <p class="mt-0 mb-1 ml-2 font-weight-bold tx-12">E-SHOP</p>
        ...
        <header class="mdc-top-app-bar">
          <div class="mdc-top-app-bar__row">
            <div class="mdc-top-app-bar__section mdc-top-app-bar__section--align-start">
              ...
              <span class="mdc-top-app-bar__title">Alaa kaook Dashboard</span>
              ...
              <div class="menu-button-container menu-profile d-none d-md-block">
                <button class="mdc-button mdc-menu-button">
                  <span class="d-flex align-items-center">
                    ...
                    <span class="user-name">Alaa Kaook</span>
                  </span>
                </button>
