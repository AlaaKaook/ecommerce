        ...
        <div class="container">
            <div class="row">
                                        ...
                                        @foreach ($latest_product as $producte)
                                            <a href="#" class="latest-product__item">
                                                <div class="latest-product__item__pic">
                                                    <img src="{{ asset('producte_img/' . $producte->image) }}"
                                                        alt="">
                                                </div>
                ...
                <div class="col-lg-9 col-md-7">
                    <div class="product__discount">
                        ...
                        <div class="row">
                            <div class="product__discount__slider owl-carousel">
                                @php
                                    $price_after_selling = 0;
                                @endphp
                                @foreach ($product_with_sell as $item)
                                    @php
                                        $price_after_selling = $item->original_price - ($item->original_price * $item->selling_price) / 100;
                                    @endphp
                                    ...
                                    <div class="col-lg-4">
                                        <div class="product__discount__item">
                                            <div class="product__discount__item__pic set-bg"
                                                ...
                                                <div class="product__discount__percent">-{{ $item->selling_price }}%</div>
                                            ...
                                            <div class="product__discount__item__text">
                                                ...
                                                <div class="product__item__price">${{ $price_after_selling }}
                    ...
                    {{ $productes->links('pagination::new_simple_paginate') }}
