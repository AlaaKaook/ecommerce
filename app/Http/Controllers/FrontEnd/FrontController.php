...
class FrontController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.Front_App.front2' , ['categories' =>$categories , 'productes'=>$productes , 'latest_product'=> $latest_product , 'prod_trending' => $prod_trending , 'featured_product'=>$featured_product ,'sliders'=>$sliders]);
    }
